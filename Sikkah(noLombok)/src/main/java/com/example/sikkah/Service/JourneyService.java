...
import com.example.sikkah.Model.*;
import com.example.sikkah.Repository.*;
...
public class JourneyService {
    ...
    public JourneyService(JourneyRepository journeyRepository, UserRepository userRepository, StationRepository stationRepository, TicketRepository ticketRepository, RouteRepository routeRepository, ScheduleRepository scheduleRepository, MaintenanceRepository maintenanceRepository, EmailService emailService) {
